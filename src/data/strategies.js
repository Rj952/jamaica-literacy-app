export const strategies = [
  {
    ...
    tactics: [
      { name: 'Phonological Awareness Warm-Up (5 min)', description: 'Daily rhyme, syllable clap, or onset-rime activity using familiar Jamaican words, songs, or rhymes.' },
      { name: 'Explicit Phonics Instruction (10 min)', description: 'Teach one grapheme-phoneme correspondence explicitly. Use decodable texts featuring Jamaican names and contexts.' },
      { name: 'Guided Reading Groups (15 min)', description: 'Small groups matched to reading level rotate through the teacher. Use NCLP Informal Diagnostic Reading Inventory to inform group placement.' },
      { name: 'Independent Reading & Vocabulary (10 min)', description: 'Students read independently at their level. Pre-teach 3\u20135 Tier 2 vocabulary words from the text before independent reading.' },
      { name: 'Fluency Read-Aloud (5 min)', description: 'Model fluent reading with appropriate pace and expression using culturally relevant Caribbean texts. Echo reading or choral reading with the class.' },
    ],
    tips: [
  ...
  },
  {
    ...
    gradeRange: 'K\u20139',
    tactics: [
      { name: 'Code-Switching Discussion (K\u20133)', description: 'Acknowledge JC as a valid home language. Use JC to activate prior knowledge ("Weh yuh know bout...?"), then scaffold into SJE equivalents.' },
      { name: 'Contrastive Grammar Chart (Grades 4\u20139)', description: 'Create a two-column "language bridge" chart \u2014 JC expression on the left, SJE equivalent on the right. Students build this chart across the year.' },
      { name: 'Register Awareness Tasks', description: 'Present texts in both registers. Students identify which is SJE, which is JC, and discuss when each is appropriate (home vs. school vs. workplace).' },
      { name: 'JC Oral Retelling \u2192 SJE Writing', description: 'Students retell a story or explain a concept orally in JC, then draft the same content in written SJE. Bridges oral fluency to academic writing.' },
    ],
    tips: [
  ...
  },
  {
    ...
    tactics: [
      { name: 'Purposeful Screen Reading', description: 'Assign structured digital reading tasks with explicit instruction in how to navigate, skim, scan, and evaluate online texts. Use websites from reputable Jamaican institutions (NLJ, MOEY, JIS).' },
      { name: 'Digital Drafting & Publishing', description: 'Students use devices to draft, revise, and publish written work. Teach digital writing conventions (hyperlinks, headers, audience awareness online).' },
      { name: 'Research & Source Evaluation', description: 'Model how to search, evaluate credibility, and cite digital sources. Align to NSC Study Skills strand: reading for information and research skills.' },
      { name: 'Multimodal Text Creation', description: 'Students create texts that combine writing with images, audio, or video. Platforms: Google Slides, Canva (free), or school-approved tools.' },
    ],
    tips: [
  ...
  },
  {
    ...
    tactics: [
      { name: 'Literate Home Environment Workshops', description: "Host parent sessions (modelled on NCLP's \"Creating and Maintaining a Literate Home Environment\" programme) that teach read-aloud routines, home library creation, and print-rich environment strategies." },
      { name: 'Reading Partnership Bags', description: 'Send home weekly reading bags with levelled books, activity cards, and a simple reading log. Parents sign off on reading done at home.' },
      { name: 'Community Text Walks', description: 'Use community signs, billboards, menus, and church bulletins as authentic reading material for home reading activities. Grounds literacy in local context.' },
      { name: 'Read-Aloud Modelling', description: 'Teach parents simple read-aloud techniques (pausing to predict, asking questions, pointing to words). NCLP parent training sessions recorded hundreds to over a thousand participants.' },
    ],
    tips: [
  ...
  },
  {
    ...
    tactics: [
      { name: 'Diagnostic-First Protocol', description: 'Administer the NCLP Informal Diagnostic Reading Inventory at the start of the year and after each term. Use scores to place students in intervention tiers.' },
      { name: 'Structured Intervention Groups', description: 'Small groups (3\u20135 students) meeting 3\u20134x per week for targeted decoding, fluency, or comprehension instruction. Sessions are 15\u201320 minutes, outside the regular reading block.' },
      { name: 'Corrective Reading Programmes', description: 'Use NCLP-endorsed corrective reading materials for students significantly below grade level. Reading coaches can model and co-deliver these sessions.' },
      { name: 'Progress Monitoring (Bi-weekly)', description: 'Use 1-minute fluency probes or running records every 2 weeks to track growth in intervention groups. Adjust grouping and strategy based on data.' },
    ],
    tips: [
  ...
  },
  {
    ...
    tactics: [
      { name: 'Running Records', description: 'Use running records weekly with early readers to track accuracy, fluency, and comprehension. Inform guided reading group placement.' },
      { name: 'NSC Attainment Target Checklists', description: 'Create simple observation checklists drawn directly from NSC attainment targets. Record evidence of each target being met over the term.' },
      { name: 'Exit Tickets', description: "End each lesson with a 2-minute written or oral exit ticket tied to the lesson's NSC learning objective. Informs next-day instruction." },
      { name: 'Grade 4 Mock Literacy Tests', description: 'Administer practice Grade 4 Literacy Test items from Term 2 of Grade 3 onward. Familiarise students with format, vocabulary, and question types.' },
      { name: 'GSAT Language Arts Preparation (Grade 6)', description: 'Use past GSAT Language Arts questions (2009\u20132013 national average: 57\u201362%) as formative practice to identify gaps in reading and writing.' },
    ],
    tips: [
